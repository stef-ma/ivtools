...
2. **Process the Imported IV File**  
   ...
   - Fit powerlaw model to the IV curve
   - Store results for visualization or export

3. **Save IVs and Fits**  
   Export processed IV curves and their corresponding fit results to disk.  
   Supports CSV, including metadata for later reference or reporting. Has special capability for easier reading in OriginLab.
